...
<body>
    <form id="form1" runat="server">
        <h1>Student Panel</h1>
        <h2>Welcome Ranu, Please Start the Test.</h2>
        <div class="wrapper">
            <div class="box">
                <h3>Start Test</h3>
                <asp:Button ID="Button1" runat="server" Text="Button" BackColor="#009933"/></div>
            <div class="box">
                <h3>Results</h3>
            ...
            <div class="box">
                ...
                <div>
                    ...
                    <br /><br/>
                    <asp:Button ID="Button2" runat="server" Text="Submit" BackColor="#009933" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="Button3" runat="server" Text="Clear" BackColor="#CC0000" /></div>
            </div>
        </div>
    </form>
</body>
